...
export class EmailService {
  ...
  async sendVerificationEmail(email: string, verificationCode: string): Promise<{messageId: string, accepted: string[]}> {
    try {
      const mailOptions = {
      ...
      console.log('Outgoing email content:', JSON.stringify(mailOptions, null, 2));
